...
import { jamFormSchema } from "@/lib/validator";
import { jamDefaultValues } from "@/constants";
...
const JamForm = ({ userId, type }: JamFormProps) => {
  const initialValues = jamDefaultValues;
  ...
  function onSubmit(values: z.infer<typeof jamFormSchema>) {
    console.log(values);
  }
